...
FirebaseData Fert_A,Fert_B,Hour,Load,Moister;
FirebaseJson json;
...
//  Firebase.setReadTimeout(Load_Pressed, 1000 * 60);
//  Firebase.setwriteSizeLimit(Load, "tiny");
...
//    }       
//    if(Firebase.getInt(Load, "Testing/Load")){ 
//    Serial.print("Load = "); 
//    Serial.println(Load.intData());
    }
...
//      Serial.print(Manual);
    ...
    if (Moister_coverting_from_S <=Moister_from_config_coverting){ // if moister lower than the config value its going to be activated
